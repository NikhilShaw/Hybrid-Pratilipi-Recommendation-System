...
# class for storing accuracy metrics
...
def calculate_accuracy(user_name_list, recommended_pratilipi_list):
    """
    calculates accuracy given user and recommended list

    :param user_name_list: list of user id
    :param  recommended_pratilipi_list: list of pratilipi id
    :return: list of accuracy_metrics
    """
    # load test dataframe
    ...
    for index, row in test.iterrows():
        ...
        if match_index is not None:
            ...
            if row["pratilipi_id"] in  recommended_pratilipi_list[match_index]:
